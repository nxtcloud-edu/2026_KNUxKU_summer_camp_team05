"""Codex Runtime Gateway ASGI 애플리케이션."""
...
def create_app(*, service: GatewayService | None = None, settings: GatewaySettings | None = None) -> FastAPI:
    @asynccontextmanager
    ...
    application = FastAPI(title="MOA Codex Runtime Gateway", version="0.1.0", lifespan=lifespan)
