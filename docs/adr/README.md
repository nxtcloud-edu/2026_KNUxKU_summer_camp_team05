...
| [0002](0002-agent-roles.md) | Accepted (MVP) | 공식 역할은 Proxy, CandidateEvidence, CategoryArbiter, TripOrchestrator, PlanFinalizer 다섯 종류다. |
...
- 첫 실행 범위는 오사카 숙소 한 카테고리지만 공식 wire 계약은 다섯 역할·다섯 카테고리를 사용한다. 전체 카테고리 실행, 네 도시, 예약은 현재 MVP 완료 조건이 아니다.
